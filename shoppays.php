...
<head>
    ...
    <title>capyfoot/shoppays.php</title>
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    ...
                    <ul class="list-unstyled templatemo-accordion">
                        <li class="pb-3">
                            <a id="bouton1"  class="btn btn-outline-secondary">
                        ...
                        <li class="pb-3">
                            ...
                            <a id="bouton2"  class="btn btn-outline-secondary" href="shopsympa.php">
                                <p class="collapsed d-flex justify-content-between h3 text-decoration text-warning"
                                    >
                                    Page 2
                                </p>
...
?>
    ...
    <script src="js/shoppaysCapyfoot.js"></script>
</body>
